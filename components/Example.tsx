...
export default function Example({ examples }: any) {
  ...
  return (
    <div className='border-2 border-l-8 mx-3 p-5 rounded-lg border-[#264653] mb-4 bg-white'>
      <div className="text-2xl font-semibold mb-2">
        Examples
      </div>
        <ul className={count > 10 ? 'max-h-[72vh] overflow-auto': 'max-h-[72vh] overflow-auto'}>
            {status === "success" ? (
